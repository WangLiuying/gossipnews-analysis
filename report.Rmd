...
topic.total = topic.total[order(topic.total$freeq),]

ggplot(data=topic.total,mapping=aes(x=1,y=freeq,fill=reorder(Var1,freeq)))+
  ...
  guides(fill="none",colour = 'none')+theme_light()+
  theme(axis.text.y =element_blank())+scale_fill_brewer(breaks = topic.total$Var1,palette = 'Spectral')
...
ggplot(df.merge,mapping = aes(x=account,fill=topics))+
  ...
  guides(fill=guide_legend(title="主题"))+theme_light()+
  scale_fill_brewer(palette="PuBu")
  #scale_fill_manual(values=c(
  #   '电影评论'='#aa00ff','家庭亲子生活'='#ea80fc','演员演艺点评'='#673ab7','粉丝八卦爆料'='#7c4dff','明星婚姻'='#4527a0','港台娱乐圈'='#304ffe','歌唱综艺节目'='#536dfe','时尚穿搭'='#2196f3','豪门风云'='#81d4fa'
  # ))
```
